...
-- 插入預設輪播項目
INSERT INTO carousel_items (title, description, image_url, button_text, button_link, display_order, is_active) VALUES
...
-- 插入預設輪播設定
INSERT INTO carousel_settings (id, auto_slide_interval, enable_auto_slide, enable_controls, enable_indicators) VALUES
(1, 5000, 1, 1, 1);
